...
const PIISanitizer = () => {
  ...
  const [websites, setWebsites] = useState<Website[]>(cloneDefaults.websites());
  ...
  const [sanitizations, setSanitizations] = useState<Sanitization[]>(cloneDefaults.sanitizations());
  ...
  const resetToDefaults = () => {
    const defaults = cloneDefaults.sanitizations();
    setSanitizations(defaults);
    saveToStorage('sanitizations', defaults);
    setShowResetAlert(false);
  };

  const resetWebsitesToDefaults = () => {
    const defaults = cloneDefaults.websites();
    setWebsites(defaults);
    saveToStorage('websites', defaults);
